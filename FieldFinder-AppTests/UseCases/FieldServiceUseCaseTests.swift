//
//  FieldServiceUseCaseTests.swift
...
final class FieldServiceUseCaseTests: XCTestCase {
    ...
    func test_UploadFieldImages_CallsServiceWithCorrectData() async throws {
        ...
        // Act
        try await useCase.uploadFieldImages(fieldID: "1", images: fakeImages)
        // Assert
    ...
    func test_UpdateField_callsServiceWithCorrectModel() async throws {
        ...
        // Act
       let result = try await useCase.updateField(fieldID: "1", fieldModel: updatedRequest)
        // Assert
        //Updated Request
    ...
    func test_FetchField_ShouldReturnField_WhenIDIsValid() async throws {
        // Act
        let field = try await useCase.fetchField(with: "1")
        // Assert
    ...
    func test_DeleteField_ShouldDeleteField_WhenIdIsValid() async throws {
        // Act
        try await useCase.deleteField(fieldID: "1")
